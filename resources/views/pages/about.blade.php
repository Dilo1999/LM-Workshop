...
<section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="relative">
                <img src="{{ asset('images/aboutus/The Strength Behind LM Workshop.jpeg') }}" alt="Professional engineering facility" class="w-full h-64 sm:h-80 lg:h-[440px] object-cover">
            </div>
            <div>
