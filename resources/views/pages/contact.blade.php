        ...
        <div class="grid lg:grid-cols-5 gap-10">
            <div class="lg:col-span-2">
                <div class="h-full p-8 bg-navy">
                    <div class="mb-8">
                        <div class="w-12 h-12 flex items-center justify-center font-heading font-bold text-base mb-4 bg-gold text-navy-deep">LM</div>
                        ...
                        @foreach([
                            ...
                            <div class="flex items-start gap-3">
                                <div class="w-9 h-9 flex items-center justify-center shrink-0 bg-gold/12">
                                    <x-lm.icon :name="$icon" :size="15" class="text-gold" />
                                </div>
                                <div>
                ...
                @if(session('contact_success'))
                    <div class="p-10 border border-gold text-center bg-quote-bg">
                        <div class="w-14 h-14 mx-auto mb-4 flex items-center justify-center bg-gold">
                            <x-lm.icon name="send" :size="24" class="text-navy-deep" />
                        </div>
...
<section class="h-64 relative overflow-hidden bg-cream">
    ...
    <div class="absolute inset-0 flex items-center justify-center">
        <div class="text-center">
            ...
            <p class="font-heading font-bold text-sm uppercase tracking-widest text-navy">Malé, Maldives</p>
