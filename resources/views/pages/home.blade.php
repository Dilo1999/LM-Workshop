    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div>
                ...
                <p class="text-gray-500 mb-4 leading-relaxed font-body">Reliable operations don't happen by chance. Every successful business depends on equipment, systems and infrastructure performing exactly as they should.</p>
                <p class="text-gray-500 mb-4 leading-relaxed font-body">Whether it's a resort welcoming guests, a vessel transporting cargo, a construction project working against strict deadlines or an industrial facility operating around the clock, uninterrupted operations are essential to success.</p>
                <p class="text-gray-500 mb-4 leading-relaxed font-body">When critical equipment fails, the impact extends far beyond the repair itself. Productivity slows, operating costs increase, schedules are disrupted and customer experience can be affected.</p>
                <p class="text-gray-500 mb-8 leading-relaxed font-body">At LM Workshop, our role is not simply to repair equipment — it is to help organisations maintain reliable operations through practical engineering expertise, responsive technical support and dependable workmanship.</p>
...
<section class="relative py-28 overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6">
        <div class="max-w-2xl">
            ...
            <p class="text-white/70 mb-4 leading-relaxed font-body">Engineering is not only about repairing equipment when problems occur. It is about helping businesses operate with confidence.</p>
            <p class="text-white/70 mb-8 leading-relaxed font-body">By combining practical engineering knowledge with responsive support and dependable workmanship, LM Workshop helps organisations minimise downtime, improve equipment reliability and maintain efficient operations.</p>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="flex items-center justify-center">
                <div class="p-10 text-center bg-navy">
                    ...
                    <p class="text-white/55 text-sm leading-relaxed font-body">Reliable engineering support for marine, industrial and commercial operations across the Maldives.</p>
