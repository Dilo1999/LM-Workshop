            ...
            @foreach($team as $member)
                <div class="team-card bg-white group overflow-hidden hover:shadow-xl transition-shadow duration-300">
                    <div class="relative h-56 overflow-hidden">
                        <img src="{{ $images[$member['img']] }}" alt="{{ $member['name'] }}" class="w-full h-full object-cover grayscale-[20%] transition-transform duration-500">
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            @foreach([
                ['Safety First', 'Every engineer is trained in safe work practices and complies with safety requirements across all project environments.'],
                ['Technical Excellence', 'Continuous learning and on-the-job experience ensure our team stays current with engineering standards and best practices.'],
                ['Accountable Professionals', 'Our engineers take pride in their work and take responsibility for the quality of every project they deliver.'],
            ] as [$heading, $body])
