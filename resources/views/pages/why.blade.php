    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="flex flex-col gap-4">
                @foreach(['Written proposals and agreed scopes of work', 'Experienced engineers deployed on every project', 'Quality checks before project completion and handover', 'Follow-up support to ensure lasting performance', 'Preventive maintenance planning to reduce future risk'] as $item)
                    <div class="flex items-start gap-3 p-4 border border-white/10">
                        <x-lm.icon name="check-circle" :size="16" class="text-gold shrink-0 mt-0.5" />
